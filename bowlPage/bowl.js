...
function selectPrimaryFoodContainer(containerID) {
    ...
    if (primaryFoodContainerSelected.classList.contains("selectAnimation") != true && primaryDishesSelected < 1) {
    ...
    if (primaryDishesSelected == 1 && secondaryDishesSelected == 1) {
...
function addToCart() {
    ...
    for (let i = 0; i < firstCartArray.length; i++){
        ...
        if(secondaryCartArray.length == 2){
            cartArray.push("Bowl with " + secondaryCartArray[0] + " and " + secondaryCartArray[1])
